  ...
  return (
    <div className="w-full">
     ...
     <Link to="/">
        ...
        <form className="w-[370px] mx-auto flex flex-col items-center gap-y-1 pt-11 ">
      ...
      <div className="w-full  bg-gray-100 flex flex-col gap-4 justify-center items-center py-10">
